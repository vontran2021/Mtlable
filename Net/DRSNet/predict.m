trainingSetup = load("D:\MATLAB\bin\DSshuffle_2022_04_11__17_14_03.mat");

imdsTrain = imageDatastore("D:\data_set\sample\train","IncludeSubfolders",true,"LabelSource","foldernames");
imdsValidation = imageDatastore("D:\data_set\sample\val","IncludeSubfolders",true,"LabelSource","foldernames");
imdspredict = imageDatastore('D:\data_set\sample\test',"IncludeSubfolders",true,"LabelSource","foldernames");
...
augimdspredict = augmentedImageDatastore([224 224 3],imdspredict);
...
tempLayers = [
    convolution2dLayer([1 1],136,"Name","conv_1","Padding","same","Stride",[2 2])
    batchNormalizationLayer("Name","batchnorm_1")
    reluLayer("Name","relu_1")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    additionLayer(3,"Name","node_28")
    convolution2dLayer([1 1],136,"Name","conv_2","Padding","same")
    batchNormalizationLayer("Name","batchnorm_10")
    reluLayer("Name","node_29")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],136,"Name","conv_11","Padding","same")
...
tempLayers = [
    additionLayer(3,"Name","node_52")
    convolution2dLayer([1 1],136,"Name","conv_3","Padding","same")
    batchNormalizationLayer("Name","batchnorm_9")
    reluLayer("Name","node_53")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],272,"Name","conv_4","Padding","same","Stride",[2 2])
...
tempLayers = [
    additionLayer(3,"Name","node_77")
    convolution2dLayer([1 1],272,"Name","conv_5","Padding","same")
...
tempLayers = [
    convolution2dLayer([1 1],272,"Name","conv_12","Padding","same")
...
tempLayers = [
    additionLayer(3,"Name","node_101")
    convolution2dLayer([1 1],272,"Name","conv_6","Padding","same")
    batchNormalizationLayer("Name","batchnorm_7")
    reluLayer("Name","node_102")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],272,"Name","conv_13","Padding","same")
...
tempLayers = [
    additionLayer(3,"Name","node_149")
    convolution2dLayer([1 1],272,"Name","conv_7","Padding","same")
...
tempLayers = [
    convolution2dLayer([1 1],544,"Name","conv_8","Padding","same","Stride",[2 2])
...
tempLayers = [
    additionLayer(3,"Name","node_174")
    convolution2dLayer([1 1],544,"Name","conv_9","Padding","same")
...
tempLayers = [
    additionLayer(3,"Name","node_198")
    convolution2dLayer([1 1],544,"Name","conv_10","Padding","same")
...
lgraph = connectLayers(lgraph,"node_4","conv_1");
...
lgraph = connectLayers(lgraph,"relu_1","node_28/in3");
lgraph = connectLayers(lgraph,"node_29","conv_11");
lgraph = connectLayers(lgraph,"node_29","node_30");
lgraph = connectLayers(lgraph,"node_29","node_40/in2");
lgraph = connectLayers(lgraph,"relu_4","node_52/in3");
...
lgraph = connectLayers(lgraph,"node_53","conv_4");
lgraph = connectLayers(lgraph,"node_53","node_54");
lgraph = connectLayers(lgraph,"node_53","node_64");
lgraph = connectLayers(lgraph,"relu_2","node_77/in3");
...
lgraph = connectLayers(lgraph,"node_78","conv_12");
lgraph = connectLayers(lgraph,"node_78","node_89/in2");
lgraph = connectLayers(lgraph,"relu_5","node_101/in3");
...
lgraph = connectLayers(lgraph,"node_102","conv_13");
lgraph = connectLayers(lgraph,"node_102","node_103");
lgraph = connectLayers(lgraph,"node_102","node_137/in1");
lgraph = connectLayers(lgraph,"relu_6","node_149/in3");
lgraph = connectLayers(lgraph,"node_112","node_137/in2");
...
lgraph = connectLayers(lgraph,"node_150","conv_8");
lgraph = connectLayers(lgraph,"node_161","node_162/in2");
lgraph = connectLayers(lgraph,"relu_3","node_174/in3");
...
lgraph = connectLayers(lgraph,"node_175","node_198/in3");
...
tic;
predictedLables = classify(net, augimdspredict);

figure
confusionchart(imdspredict.Labels, predictedLables);

accuracy = mean(predictedLables == imdspredict.Labels);
t=toc;
